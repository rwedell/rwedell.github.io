...
:::: {style="display: flex;"}
If you're ready for some real excitement, and real excitement to you is reading grad school capstone projects about data analysis and COVID modeling, then check this out. I worked on this project for 
